...
function drawPhylogeneticTree(jsonData) {
    ...
    const isRadialTree = Boolean(+document.getElementById(`isRadialTree`).checked);
    const showDistanceToParent = Boolean(+document.getElementById(`showDistanceToParent`).checked);
