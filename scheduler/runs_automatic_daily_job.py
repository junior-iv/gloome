...
kwargs = {'msaText': read_file(f'msa/patternMSA{file_number}.msa'),
          ...
          'fileBranchPositionProbabilitiesTsv': int(DEFAULT_ARGUMENTS.file_branch_position_probabilities_tsv),
          ...
          'fileTableOfParsimonyAndHomoplasyScores':
              int(DEFAULT_ARGUMENTS.file_table_of_parsimony_and_homoplasy_scores_tsv),
